...
QHash<QString, RadioInfo::Radio> RadioInfo::_radiosByName = QHash<QString, RadioInfo::Radio>{
...
QHash<unsigned, RadioInfo> RadioInfo::_radiosById = QHash<unsigned, RadioInfo>{
