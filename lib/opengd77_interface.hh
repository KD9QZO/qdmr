#ifndef OPENGD77INTERFACE_HH_
#define OPENGD77INTERFACE_HH_

#include "usbserial.hh"


/**
 * \brief Implements the interfact to a radio running the Open GD77 firmware.
 *
...
protected:
	...
	* This command must be send before writing to the flash memory. */
	...
	/** Finalize writing to the Flash memory. If not send after writing to a sector, the changes are lost. */
